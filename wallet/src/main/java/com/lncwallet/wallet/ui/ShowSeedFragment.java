...
public class ShowSeedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Fonts.setTypeface(view.findViewById(R.id.seed_password_protected_lock), Fonts.Font.LNCWALLET_FONT_ICONS);
        qrView = (ImageView) view.findViewById(R.id.qr_code_seed);

        TextView lockIcon = (TextView) view.findViewById(R.id.lock_icon);
        Fonts.setTypeface(lockIcon, Fonts.Font.LNCWALLET_FONT_ICONS);
