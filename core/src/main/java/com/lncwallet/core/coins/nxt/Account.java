package com.lncwallet.core.coins.nxt;
...
//                + " existing key " + com.lncwallet.core.coins.nxt.Convert.toHexString(account.getPublicKey()) + " new key " + com.lncwallet.core.coins.nxt.Convert.toHexString(publicKey));
//    }
...
//        if (id != com.lncwallet.core.coins.nxt.Crypto.rsDecode(com.lncwallet.core.coins.nxt.Crypto.rsEncode(id))) {
...
//        name = com.lncwallet.core.coins.nxt.Convert.emptyToNull(name.trim());
//        description = com.lncwallet.core.coins.nxt.Convert.emptyToNull(description.trim());
...
//            data = com.lncwallet.core.coins.nxt.Convert.compress(data);
//        }
//        return EncryptedData.encrypt(data, com.lncwallet.core.coins.nxt.Crypto.getPrivateKey(senderSecretPhrase), getPublicKey());
//    }
//
...
//        }
//        byte[] decrypted = encryptedData.decrypt(com.lncwallet.core.coins.nxt.Crypto.getPrivateKey(recipientSecretPhrase), getPublicKey());
//        if (uncompress && decrypted.length > 0) {
//            decrypted = com.lncwallet.core.coins.nxt.Convert.uncompress(decrypted);
//        }
//        return decrypted;
//    }
//
